...
class DataPreprocessor(object):
    ...
    def __init__(self , project_folder_dir , tier):
        self.project_folder_dir = project_folder_dir  # Removed trailing comma (was creating tuple)
        self.tier = tier
    ...
    def get_each_Vision_Area_Per_Tier(self, project_folder_dir, tier):
        ...
        # EXAMPLE ##########################################
        # project_folder_dir : C:\Users\sykim1106\Desktop\pyLoL or C:\dataset
        # tier : CHALLENGER
        ####################################################
        INITIAL = 0
        ...
        # Each match folder => example: C:\Users\sykim1106\Desktop\pyLoL\CHALLENGER\KR-6415928037
